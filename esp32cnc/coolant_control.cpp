...
void coolant_init()
{
	pinMode(COOLANTPIN,OUTPUT); // Configure as output pin
#ifdef ENABLE_M7
...
#ifdef INVERT_COOLANT_FLOOD_PIN
		 digitalWrite(COOLANTPIN, 0);
		//	COOLANT_FLOOD_PORT &= ~(1 << COOLANT_FLOOD_BIT);
#else
		 digitalWrite(COOLANTPIN, 1);
		//	COOLANT_FLOOD_PORT |= (1 << COOLANT_FLOOD_BIT);
#endif
		}
